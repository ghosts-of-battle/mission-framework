...
class GHOST_AdminPanel {
    ...
    class controls {
        ...
        class MAIN_TITLE: RscADMPStructuredText {
            ...
            text = "<t font='PuristaBold', align='center'>GHOST ADMIN PANEL</t>"; //--- ToDo: Localize;
            x = 0.216406 * safezoneW + safezoneX; // TODO: ADMINPANEL EXPANSION // x = 0.0926563 * safezoneW + safezoneX;
            y = 0.159 * safezoneH + safezoneY;
            w = 0.567187 * safezoneW; // TODO: ADMINPANEL EXPANSION // w = 0.819844 * safezoneW;
            h = 0.022 * safezoneH;
            colorBackground[] = COL_GHOSTORANGE_SEMITRANSP;
        };
        ...
        class PLAYER_SKILLS_COMM_COMBO: RscADMPCheckbox {
        ...
        class ADMIN_MESSAGE: RscADMPButton {
            ...
            onButtonClick = "createDialog 'GHOST_AdminMessage';";
        };
    };
};

class GHOST_AdminMessage {
    idd = 6970;
    movingEnable = false;
    enableSimulation = 1;
    ...
    class controls {
        ...
        class MAIN_TITLE: RscADMPStructuredText {
            ...
            text = "<t font='PuristaBold', align='center'>GHOST ADMIN MESSAGE</t>";
            x = 8 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X;
