...
admp_authorisedIDs = [];
{admp_authorisedIDs pushBackUnique _x;} forEach ["_SP_AI_", "_SP_PLAYER_", "76561198000002705"]; // Make sure YonV always have admin access for redundancy
...
if (hasInterface) then {
    ["GHOST Admin Panel","open_admin_panel", ["Open Admin Panel", "Opens the GHOST Admin Panel. If you do not have admin access, this will open the message menu instead."], {_this call admp_fnc_panelButtonPressed;}, "", [0xC5, [false, false, false]]] call CBA_fnc_addKeybind;
    ["GHOST Admin Panel","open_admin_message", ["Open Admin Message Menu", "Shortcut for opening the GHOST Admin Message menu."], {_this call admp_fnc_panelButtonPressed;}, "", [0xC5, [true, false, false]]] call CBA_fnc_addKeybind;
};
