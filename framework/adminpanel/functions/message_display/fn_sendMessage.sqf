...
// if the message is a general announcement set sender name to 'GHOST Admin' instead
private _senderName = name player;
if (_recipient in ["AllPlayers", "AllAlive", "AllDead"]) then {_senderName = "GHOST Admin";};
