...
#define IDC_ADMINPANEL_PLAYER_SKILLS_COM_CHECKBOX 27911
...
private _com_checkbox = _admp_display displayCtrl IDC_ADMINPANEL_PLAYER_SKILLS_COM_CHECKBOX;
...
private _comSkill = _player getVariable ["ghost_iscom",_player getUnitTrait "UAVHacker"];
...
_com_checkbox cbSetChecked _comSkill;