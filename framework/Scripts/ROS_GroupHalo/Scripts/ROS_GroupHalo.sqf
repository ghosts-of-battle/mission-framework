...
this addAction ["<t color='#ff9900'>HALO C130</t>",{params ["_target", "_caller"]; [_caller, C130] execVM "Scripts\ROS_GroupHalo\Scripts\ROS_GroupHalo.sqf"},[],1.5,false,false,"","player distance _target <3 && count (((position C130) nearObjects ['CAManBase', 10]) select {alive _x}) ==0"];
this addAction ["<t color='#b2ff66'>Move C130</t>",{[C130] execVM "Scripts\ROS_GroupHalo\Scripts\ROS_MoveHaloPlane.sqf"},[],1.4,false,false,"","player distance _target <3 && count (((position C130) nearObjects ['CAManBase', 10]) select {alive _x}) ==0"];

private _ghostHALO = [
    "ghostHALO",
    "Halo",
    "", {
        {params ["_target", "_caller"]; [_caller, C130] execVM "Scripts\ROS_GroupHalo\Scripts\ROS_GroupHalo.sqf"}
    }, {true}, {},
    [_area]
...
private _ghostMOVE = [
    ...
    "Move c130",
    "", {
        {[C130] execVM "Scripts\ROS_GroupHalo\Scripts\ROS_MoveHaloPlane.sqf"}
    }, {true}, {},
    [_area]
] call ACE_interact_menu_fnc_createAction;

[this, 0, ["ACE_MainActions"], _ghostMOVE] call ACE_interact_menu_fnc_addActionToObject;
[this, 0, ["ACE_MainActions"], _ghostHALO] call ACE_interact_menu_fnc_addActionToObject;


2) Add the following line to the init field of the C130:

[this] execvm "Scripts\ROS_GroupHalo\Scripts\c130LightsandEngine.sqf";
...
this addAction ["<t color='#3399ff'>Weather Report</t>", "Scripts\ROS_GroupHalo\Scripts\ROS_weatherReport.sqf",[], 1.3, false, false,"","_this distance _target < 3"];

private _ghostWEATHER = [
    "ghostweather",
    "Weather Report",
    "", {
        "Scripts\ROS_GroupHalo\Scripts\ROS_weatherReport.sqf"
    }, {true}, {},
    [_area]
] call ACE_interact_menu_fnc_createAction;

[this, 0, ["ACE_MainActions"], _ghostWEATHER] call ACE_interact_menu_fnc_addActionToObject;
...
// Transfer all Halo (AI and player) units to plane
{
	...
	if (_enableSmoke) then {
		[[_x],"Scripts\ROS_GroupHalo\Scripts\ROS_ParaSmoke.sqf"] remoteExec ["execVM", _x];
	};
	sleep 0.1;
...
// Change light colour - see Scripts\ROS_GroupHalo\Scripts\c130LightsandEngine.sqf
