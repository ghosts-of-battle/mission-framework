 ...
 * For sound to work shot_inside.ogg needs to be inside Scripts\Data\sounds
 * 
 * Arguments:
 * None
 * 
...
ms_insideParticles_playSound = {
    ...
    if (!fileExists getMissionPath "Scripts\Data\sounds\shot_inside.ogg") exitWith {};
    ...
    _sources spawn {
        {
            playSound3D [getMissionPath "Scripts\Data\sounds\shot_inside.ogg", _x, true, getPosASLVisual _x, 50, 0.9 + random 0.2, 100, 0, true];
            sleep 0.01;
        } forEach _this;
        sleep 3;
        {
