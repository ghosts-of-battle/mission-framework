...
/*
 * Author: CPL.Brostrom.A tinkered with by YonV, CPL.Dunn.W
 ...
 *
 * Example:
 * [getPos logic, this] call Ghost_fnc_zenModule_callEndex;
 *
 * Public: No
 */
...
[
    ...
    ], 
    {
        ...
        private _image = "<img size='5' image='Scripts\Data\Images\gobp2_256.paa' align='center'/><br /><br />";
                        ...
                        [
                            ...
                            "fired",
                            {
                                ...
                                private _hftitle = format[
                                    ...
                                    [_unit, 'BIS'] call EFUNC(player,getRank),
                                    [_unit] call EFUNC(unit,getName)
                                ];
                                private _hfimage = "<img size='5' image='Scripts\Data\Images\gobp2_256.paa' align='center'/><br /><br />";
