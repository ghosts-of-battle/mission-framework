 ...
 * 4: Categorys <ARRAY>                         (Optional)  [Default: ["ACE_MainActions","Ghost_Loadout_Cat_Main"]]
 * 5: Company required to use                   (Optional)  [Default: ""]
 * 6: Allow All Loadouts <BOOL>                 (Optional)  [Default: false]
 *
 * Example:
 * [this,"Rifleman","Class_Rifleman"] call Ghost_fnc_addLoadoutSelection;
 * [this,"Rifleman","Class_Rifleman","",["ACE_MainActions","Ghost_Loadout_Cat_Main"],""] call Ghost_fnc_addLoadoutSelection;
 * [this,"Rifleman","Class_Rifleman","",["ACE_MainActions","Ghost_Loadout_Cat_Main"],"", false] call Ghost_fnc_addLoadoutSelection;
 * 
 * Public: No
 */
...
params [
    ...
    ["_className", "", [""]],
    ["_icon", "", [""]],
    ["_category", ["ACE_MainActions", "Ghost_Loadout_Cat_Main"], [[]]],
    ["_company", "", [""]],
...
private _action = [format ["Ghost_Loadout_%1", _className], _lable, _icon, {
    params ["", "", "_params"];
