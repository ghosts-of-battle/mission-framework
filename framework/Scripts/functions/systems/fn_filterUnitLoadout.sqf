 ...
 *
 * Example:
 * _loadout = [_loadout] call Ghost_fnc_filterUnitLoadout;
 * _loadout = [getUnitLoadout _unit] call Ghost_fnc_filterUnitLoadout;
 * _loadout = [player] call Ghost_fnc_filterUnitLoadout;
 *
 * Public: Yes
 */
