 ...
 *
 * Example:
 * [this] call Ghost_fnc_addReGear
 * [this] call Ghost_fnc_addReGear
 * [this, ["ACE_MainActions"]] call Ghost_fnc_addReGear
 */
...
private _Icon = "Scripts\Data\Icon\icon_00.paa";
private _regearStatement = {
    [QEGVAR(gear,applyLoadout)] call CBA_fnc_localEvent;
    [[],["You have been rearmed"], [""], [""]] call CBA_fnc_notify;
    call EFUNC(rank,rank);
};
private _actionType = parseNumber (isPlayer _object);

private _regearAction = ["GhostReGearAce", "ReGear", _Icon, _regearStatement, {true}] call ace_interact_menu_fnc_createAction;
