...
private _stagingZoneMarkers = [];
{
    ...
    if (_markerName in ["zone_staging", "respawn_west", "Ghost_staging_zone"]) then {
...
private _stagingCat = [QEGVAR(Actions,StagingCategory), "Staging Zone", "Scripts\Data\Icon\icon_00.paa", {true}, _condition] call ace_interact_menu_fnc_createAction;
...
// addAction notice
player addAction [
    "<img image='Scripts\Data\Icon\icon_00.paa' /> <t color='#ffc61a'>Ghost Staging Zone</t> <img image='Scripts\Data\Icon\icon_00.paa' />",
    {
