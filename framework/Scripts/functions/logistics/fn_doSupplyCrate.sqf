...
/*
 * Author: CPL.Brostrom.A tinkered with by YonV, J.Turn
 ...
 *
 * Example:
 * [[0.0,0.0,0.0],"crate_resupply_general"] call Ghost_fnc_doSupplyCrate;
 * [[0.0,0.0,0.0],"crate_medicalAtlas"] call Ghost_fnc_doSupplyCrate;
 */
...
if (typeOf _crate in _smallBox) then {
    _crate setObjectTextureGlobal  [0, "..\..\Data\Images\AmmoBox_signs_ghost_ammo_CA.paa"];
};
if (typeOf _crate in _largeBox) then {
    _crate setObjectTextureGlobal  [1, "..\..\Data\Images\AmmoBox_signs_ghost_ammo_CA.paa"];
};
