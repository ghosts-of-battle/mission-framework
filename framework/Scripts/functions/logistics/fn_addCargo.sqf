 ...
 *
 * Example:
 * [MyCrate, [["ACE_EarPlugs", 60]]] call Ghost_fnc_addCargo;
 * [MyTruck, [["ACE_personalAidKit", 8], ["ACE_tourniquet", 10]]] call Ghost_fnc_addCargo;
 * [MyTruck, [["ACE_personalAidKit", 8], ["ACE_tourniquet", 10]], "myCrate", false] call Ghost_fnc_addCargo;
 *
 * Public: Yes
 */
