 ...
 *
 * Example:
 * [myTruck] call Ghost_fnc_setCargoAttributes;
 * [myTruck, 30, -1] call Ghost_fnc_setCargoAttributes;
 * [myCrate, -1, 2] call Ghost_fnc_setCargoAttributes;
 * [myCrate, -1, 2, true, false] call Ghost_fnc_setCargoAttributes;
 * [myCrate, nil, nil, true, false] call Ghost_fnc_setCargoAttributes;
 *
 * Public: Yes
 */
