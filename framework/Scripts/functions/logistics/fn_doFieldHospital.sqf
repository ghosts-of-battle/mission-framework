 ...
 * This scripts crate the Ghost field hostpital.
 ...
 *
 * Example:
 * [this] call Ghost_fnc_doFieldHospital;
 * [this, true, 1] call Ghost_fnc_doFieldHospital;
 */
...
_crate addAction ["<img image='Scripts\Data\Icon\icon_00.paa' /> Ghost Field Hospital", {}, [], 1.5, true, true, "", "true", 5];
