 ...
 *
 * Example:
 * [this] call Ghost_fnc_addStagingZone
 * [this, 3] call Ghost_fnc_addStagingZone
 * ["zone_staging", 12] call Ghost_fnc_addStagingZone
 * ["respawn_west", 12] call Ghost_fnc_addStagingZone
 * [[10,25,0], 12] call Ghost_fnc_addStagingZone
 * ["ShapedZoneMarker", "RECTANGLE"] call Ghost_fnc_addStagingZone
 * ["ShapedZoneMarker", "ELLIPSE"] call Ghost_fnc_addStagingZone
 * 
 * Public: Yes
 */
...
if (_zone isEqualType []) exitWith {
    ...
    private _stagingZone = createMarkerLocal [format["Ghost_staging_zone_%1", count _stagingZones], _zonePos];
