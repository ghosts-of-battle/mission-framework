 ...
 * This scripts crate the Ghost starter crate.
 ...
 *
 * Example:
 * [this] call Ghost_fnc_doStarterCrate;
 * [this,"none",true] call Ghost_fnc_doStarterCrate;
 * [this,"none",true,true,true,false,false] call Ghost_fnc_doStarterCrate;
 * [this,"none",true,true,true,false,false,true] call Ghost_fnc_doStarterCrate;
 *
 */
...
_object addAction [format ["<img image='Scripts\Data\Icon\icon_00.paa' /> Ghost%1Equipment Crate", _crateName], {}, [], 1.5, true, true, "", "true", 5];
