class GVAR(modal)
{
    ...
    class Controls
    {
        ...
        {
            idc = IDC_ghostf_ADMINMENU_MODAL_BACK;
        ...
        {
            idc = IDC_ghostf_ADMINMENU_MODAL_TBACK;
        ...
        {
            idc = IDC_ghostf_ADMINMENU_MODAL_TITLE;
            text = "Ghosts of BattleAdmin Menu";
            style = 0;
            colorBackground[] = {0, 0, 0, 0};
            x = "1.5 * (((safezoneW / safezoneH) min 1.2) / 40) + (safezoneX + (safezoneW - ((safezoneW / safezoneH) min 1.2))/2)";
            y = "2.6 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        ...
        {
            idc = IDC_ghostf_ADMINMENU_MODAL_GBACK;
        ...
        {
            idc = IDC_ghostf_ADMINMENU_G_MODAL;
        ...
        class Close
        {
            idc = IDC_ghostf_ADMINMENU_MODAL_CLOSE;
            type = 1;
            style = "48 + 2048";
