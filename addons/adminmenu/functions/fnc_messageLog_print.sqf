...
/* ----------------------------------------------------------------------------
Internal Function: ghostf_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call ghostf_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_ghostf_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[Ghosts of Battle Adminmenu] Printed entry: %1%2",
