...
class MRHSoldierTablet {
	...
	class controls 	{
		...
		class MRHTabBackGrd: RscPictureMRHSoldierTab {
			idc = 1200;
			MVT;
		...
		class MRHIconBar: RscListboxMRHSoldierTab {
			idc = 1500;
			MVT;
		...
		class MRHHomeButton: RscInvisibleButtonMRHSoldierTab {
			idc = 1600;
			MVT;
		...
		class MRHCloseButton: RscInvisibleButtonMRHSoldierTab {
			idc = 1601;
			MVT;
		...
		class MRHUpButton: RscInvisibleButtonMRHSoldierTab {
			idc = 1602;
			MVT;
			x = 0.742344 * safezoneW + safezoneX;
		...
		class MRHDownButton: RscInvisibleButtonMRHSoldierTab {
			idc = 1603;
			MVT;
			x = 0.742344 * safezoneW + safezoneX;
		...
		class MRHTimeDisplayZone: RscStructuredTextMRHSoldierTab {
			idc = 1201;
			MVT;
		...
		// screen overlay
		////////////////////////
		class MRHScrOverLay: RscPictureMRHSoldierTab {
			idc = 1277;
			MVT;
