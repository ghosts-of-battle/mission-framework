/*
Function: ghostf_fnc_LimitedArsenal
...
Description:
 ...
 ghostf_fnc_Arsenal, only the items in the container change.
...
Examples:
 (begin example)
  [this] call ghostf_fnc_LimitedArsenal;
  [this, "Aegis", 50] call ghostf_fnc_LimitedArsenal;
  [this, "VANILLA"] call ghostf_fnc_LimitedArsenal;
  [MyAmmoCrate, "RHS", 0] call ghostf_fnc_LimitedArsenal;
 (end)
